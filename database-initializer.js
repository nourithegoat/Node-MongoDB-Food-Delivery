...
let mongoClient = null; // see idk why but const mongoClient is within a function
//global local yada yada point is when i ran this i got mongoClient is not defined 

//connects to a database and resolves with the db object
async function connectToDatabase() {	
	try {	
		//const mongoClient = new mongo.MongoClient(config.dbIp);
		mongoClient = new mongo.MongoClient(config.dbIp);
